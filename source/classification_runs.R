...
list_runs[as.character(2154:2157), group_run := 6L] # exclude
list_runs[as.character(2169:2172), group_run := 6L] # exclude
list_runs[as.character(2181:2189), group_run := 7L] # 11352:11355 low ; 11356:11360 high. Unusual indeed. Exclude in the end
list_runs[as.character(2196:2197), group_run := 8L] # exclude everything, there is not much stuff anyway
list_runs[as.character(2210:2212), group_run := 9L] # oleh
